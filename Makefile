...
SRC = main.c get_arg.c print_arg.c del_elem.c del_pos.c get_pos_lst.c print_select.c\
move.c get_key.c display_selected.c free_all.c trdel_addr.c init_term.c signal.c
SRC_DIR = ./src
